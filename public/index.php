...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="parallax1 parallax-fix full-screen no-padding scroll-to-down" onclick="scrollToDown()" id="slider">
            ...
            <img class="parallax-background-img" src="https://placehold.it/1920x1200" alt="" />
            ...
            <div class="container">
                ...
                <div class="row margin-ten no-margin-bottom">
                    <div class="col-md-6 col-sm-6 text-center xs-margin-bottom-ten">
                        <img src="https://placehold.it/630x638" alt=""/>
                    </div>
        ...
        <!-- skills section -->
        <section id="skills" class="xs-onepage-section">
            <div class="container">
                <div class="row">
                    <!-- section title -->
                    <div class="col-md-12 text-center">
        ...
        <!-- end skills section -->
        <!-- pie charts section -->
        <section class="fix-background" style="background-image:url('https://placehold.it/1920x1100');">
        ...
        <!-- education section -->
        <section id="education" class="xs-onepage-section">
            <div class="container">
        ...
        <!-- end awards section -->
        <!-- portfolio section -->
        <section id="portfolio" class="no-padding-bottom xs-onepage-section">
            <div class="container">
                <div class="row">
                    <!-- section title -->
                    <div class="col-md-12 text-center">
                        ...
                        <div class="tab-content">
                            <ul class="masonry-items grid">
                                ...
                                <li class="photography graphics">
                                    <figure>
                                        <div class="gallery-img"><a href="onepage-single-project-page1.html" class="simple-ajax-popup-align-top"><img src="https://placehold.it/480x358" alt=""></a></div>
                                        <figcaption>
                                ...
                                <li class="graphics design lightbox-gallery">
                                    <figure>
                                        <div class="gallery-img"><a href="https://placehold.it/1200x800" title=""><img src="https://placehold.it/480x716" alt=""></a>
                                            <a href="https://placehold.it/1200x800" title=""></a>
                                            <a href="https://placehold.it/1200x800" title=""></a>
                                        </div>
                                        <figcaption>
                                ...
                                <li class="branding graphics design">
                                    <figure>
                                        <div class="gallery-img"><a href="onepage-single-project-page3.html" class="simple-ajax-popup-align-top"><img src="https://placehold.it/480x358" alt=""></a></div>
                                        <figcaption>
                                ...
                                <li class="photography branding design graphics">
                                    <figure>
                                        <div class="gallery-img"><a href="onepage-single-project-page5.html" class="simple-ajax-popup-align-top"><img src="https://placehold.it/480x358" alt=""></a></div>
                                        <figcaption>
                                ...
                                <li class="photography design branding">
                                    <figure>
                                        <div class="gallery-img"><a href="onepage-single-project-page2.html" class="simple-ajax-popup-align-top"><img src="https://placehold.it/480x358" alt=""></a></div>
                                        <figcaption>
                                ...
                                <li class="photography branding">
                                    <figure>
                                        <div class="gallery-img"><a href="onepage-single-project-page4.html" class="simple-ajax-popup-align-top"><img src="https://placehold.it/480x358" alt=""></a></div>
                                        <figcaption>
            ...
            <div class="container">
                ...
                <div class="row margin-ten no-margin-bottom">
                    ...
                    <div class="col-md-4 col-sm-4 wow fadeInUp">
                        <div class="blog-post">
                            <div class="blog-post-images"><a href="blog-grid-3columns.html"><img src="https://placehold.it/800x500" alt=""></a></div>
                    ...
                    <div class="col-md-4 col-sm-4 wow fadeInUp">
                        <div class="blog-post">
                            <div class="blog-post-images"><a href="blog-masonry-3columns.html"><img src="https://placehold.it/800x500" alt=""></a></div>
                            <div class="post-details">
                    ...
                    <div class="col-md-4 col-sm-4 wow fadeInUp">
                        <div class="blog-post">
                            <div class="blog-post-images"><a href="blog-right-sidebar.html"><img src="https://placehold.it/800x500" alt=""></a></div>
                            <div class="post-details">
        ...
        <!-- end blog section -->
        <!-- testimonial section -->
        <section class="fix-background" style="background-image:url('https://placehold.it/1920x800');">
            <div class="overlay-gray"></div>
            <div class="container">
                <div class="row">
